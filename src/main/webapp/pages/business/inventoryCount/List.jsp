...
<jsp:useBean id="userName" class="com.zh.base.util.JspUtil" scope="session"></jsp:useBean>
	...
	<div class="content">
		...
		<shiro:hasPermission name="inventoryCount:view">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<shiro:hasPermission name="inventoryCount:add">
							...
							<tbody>
								<s:iterator value="inventoryCountPrimaryList" var="tp" status="index">
									...
									<td><s:property value="#index.index + 1"/></td>
										...
										<td>
											<shiro:hasPermission name="inventoryCount:edit">
		...
		<shiro:lacksPermission name="inventoryCount:view">
