...
<jsp:useBean id="userName" class="com.zh.base.util.JspUtil" scope="session"></jsp:useBean>
	...
	<div class="content">
		...
		<shiro:hasPermission name="processingSingle:view">
				...
				<div class="row-fluid">
					<div>
						<form action="${menu2Id}.jspa?menuId=${menuId}&menu2Id=${menu2Id}" id="queryForm" method="post">
							...
							<dir class="row">
								<div class="span5">
									<label class="control-label">单据状态：
									<select id="inputStatus" name="processingSinglePrimary.status" class="input-medium" placeholder="状态" >
										<option value=""></option>
					...
					<div class="btn-toolbar">
						<shiro:hasPermission name="processingSingle:add">
		...
		<shiro:lacksPermission name="processingSingle:view">
