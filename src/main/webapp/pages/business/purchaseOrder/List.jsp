...
<jsp:useBean id="userName" class="com.zh.base.util.JspUtil" scope="session"></jsp:useBean>
	...
	<div class="content">
		...
		<shiro:hasPermission name="purchaseOrder:view">
				...
				<div class="row-fluid">
					<div>
						<form action="${menu2Id}.jspa?menuId=${menuId}&menu2Id=${menu2Id}" id="queryForm" method="post">
							...
							<dir class="row">
								<div class="span5">
									<label class="control-label">单号：
										<input type="text" maxlength="25" id="inputPurchaseOrderID" name="purchaseOrderPrimary.purchaseOrderID"
											value="${purchaseOrderPrimary.purchaseOrderID}" class="input-large">
										</label>
								</div>
								<div class="span4">
									<label class="control-label">供应商：
					...
					<div class="btn-toolbar">
						<shiro:hasPermission name="purchaseOrder:add">
							...
							<tbody>
								<s:iterator value="purchaseOrderPrimaryList" var="tp" status="index">
									...
									<td><s:property value="#index.index + 1"/></td>
										...
										<td>
											<shiro:hasPermission name="purchaseOrder:edit">
