...
<jsp:useBean id="userName" class="com.zh.base.util.JspUtil" scope="session"></jsp:useBean>
	...
	<div class="content">
		...
		<shiro:hasPermission name="stockStorage:view">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<shiro:hasPermission name="stockStorage:add">
							...
							<tbody>
								<s:iterator value="storagePrimaryList" var="tp" status="index">
									...
									<td><s:property value="#index.index + 1"/></td>
										...
										<td>
											<shiro:hasPermission name="stockStorage:edit">
		...
		<shiro:lacksPermission name="stockStorage:view">
