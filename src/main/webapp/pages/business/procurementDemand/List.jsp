...
<jsp:useBean id="userName" class="com.zh.base.util.JspUtil" scope="session"></jsp:useBean>
	...
	<div class="content">
		...
		<shiro:hasPermission name="procurementDemand:view">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<shiro:hasPermission name="procurementDemand:add">
							...
							<tbody>
								<s:iterator value="procurementDemandPrimaryList" var="tp" status="index">
									<tr>
										...
										<td>
											<shiro:hasPermission name="procurementDemand:edit">
		...
		<shiro:lacksPermission name="procurementDemand:view">
