				...
				<div class="row-fluid">
					...
					<div class="btn-toolbar">
						...
						<div class="pull-right">
							<shiro:hasPermission name="orderDelivery:approve">
							<s:if test="#ProcessId">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane fade" id="home">
								...
								<dir class="row">
									<div class="span4">
										<div class="control-group">
											...
											<div class="controls">
												<s:if test="#ProcessId">
												<input type="text" maxlength="30" disabled="disabled"
														id="purchaseOrderID" name="libraryPrimary.purchaseOrderID" value="${libraryPrimary.purchaseOrderID}" class="input-medium"></input>
												</s:if>
												<s:else>
												<s:select id="inputcustomerID"  list="salesOrderPrimaryList" data-required="true" listKey="orderID" listValue="orderID"
													name="libraryPrimary.purchaseOrderID" cssClass="input-medium" placeholder="销售订单">
												</s:select>
												</s:else>
											</div>
									...
									<div class="span4">
										<div class="control-group">
											<label class="control-label" for="inputlibrarydate" style="">集装箱号：</label>
											<div class="controls">
												<input type="text" maxlength="30" name="libraryPrimary.containerType"
														id="inputContainerType" value="${libraryPrimary.containerType}" class="input-medium"></input>
											</div>
										</div>
									</div>
								</dir>
