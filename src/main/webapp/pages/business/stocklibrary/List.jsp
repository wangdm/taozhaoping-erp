...
<jsp:useBean id="userName" class="com.zh.base.util.JspUtil" scope="session"></jsp:useBean>
	...
	<div class="content">
		...
		<shiro:hasPermission name="stockLibrary:view">
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="row-fluid">
					<div class="btn-toolbar">
						<shiro:hasPermission name="stockLibrary:add">
							...
							<tbody>
								<s:iterator value="libraryPrimaryList" var="tp" status="index">
									...
									<td><s:property value="#index.index + 1"/></td>
										...
										<td>
											<shiro:hasPermission name="stockLibrary:edit">
		...
		<shiro:lacksPermission name="stockLibrary:view">
