						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="home">
									...
									<div class="control-group" id="name_div">
										<label class="control-label" for="name_input">部门名称：</label>
										<div class="controls">
											<input type="text" data-required="true" maxlength="30"  id="name_input" name="dept.deptName" value="${dept.deptName}" class="input-xlarge">
										</div>
									</div>
